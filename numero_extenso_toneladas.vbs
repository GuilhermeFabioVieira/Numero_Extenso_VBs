Function Extenso_Valor(valor As Double, qtd As String) As String
...
Function arredBaixo(valor)
    Dim tmpValor
    tmpValor = Round(CDbl(Right(Round(valor, 3) * 100, 3)) / 100, 3)
    arredBaixo = Round(Round(valor, 3) - tmpValor, 0)
End Function
